...
import pyautogui
from Definitions import Separator, Column, Comando, EntityFromRow

# CONFIGURABLES      
PATH_TO_CSV = r'proveedores.csv'
columns = [#Column(enviar, teclas a enviar, separador ó [separador_1, separador_2])
            ...
            Column(True, 'TIPO_IMPUESTO_PROVEEDOR', Separator(Separator.EnumSeparator.TAB, 2)),
            Column(True, 'FORMA_COBRO_PAGO', Separator(Separator.EnumSeparator.TAB, 9)),
            Column(True, 'IDIOMA', Separator(Separator.EnumSeparator.TAB, 23)),
            Column(True, 'TIPO_PROVEEDOR', Separator(Separator.EnumSeparator.NEW)),]
