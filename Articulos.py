...
# CONFIGURABLES      
PATH_TO_CSV = r'articulos.csv'
columns = [#Column(enviar, teclas a enviar, separador ó [separador_1, separador_2])
            Column(True, 'CODIGO_ARTICULO'),
            Column(True, 'DESCRIP_COMERCIAL', Separator(Separator.EnumSeparator.TAB, 7)),
            Column(True, 'NUM_UNID_ALM', Separator(Separator.EnumSeparator.TAB, 2)),
            Column(True, 'CODIGO_IMPTO', Separator(Separator.EnumSeparator.TAB, 4)),
            Column(True, 'TIPO_CADENA_LOGISTICA', Separator(Separator.EnumSeparator.TAB, 7)),
            Column(True, 'UNIDAD_CODIGO1', Separator(Separator.EnumSeparator.CLICK, coords = (470, 128))),
            Column(True, 'CODIGO_FAMILIA', [Separator(Separator.EnumSeparator.NEW), Separator(Separator.EnumSeparator.ENTER)]),]
